...
export const particles: ParticleItem[] = [
  ...
  {
    categories: categories("data table", "multiselect", "tanstack"),
    description:
      "Data table with row selection and indeterminate header checkbox",
    files: [{ path: "particles/p-data-table-2.tsx", type: "registry:block" }],
    meta: {
      className: "**:data-[slot=preview]:w-full",
    },
    name: "p-data-table-2",
  ...
  },
  {
    ...
    files: [{ path: "particles/p-carousel-2.tsx", type: "registry:block" }],
    name: "p-carousel-2",
    registryDependencies: ["@coss/carousel"],
    type: "registry:block",
  },
  ...
  {
    categories: categories("dashboard", "chart", "card"),
  ...
  },
  {
    ...
    files: [{ path: "particles/p-empty-2.tsx", type: "registry:block" }],
    name: "p-empty-2",
    registryDependencies: ["@coss/button", "@coss/empty"],
    type: "registry:block",
  },
  ...
  },
  {
    ...
    files: [{ path: "particles/p-fieldset-2.tsx", type: "registry:block" }],
    name: "p-fieldset-2",
    registryDependencies: [
      "@coss/checkbox",
      "@coss/field",
  ...
  },
  {
    ...
    files: [{ path: "particles/p-kbd-2.tsx", type: "registry:block" }],
    name: "p-kbd-2",
    registryDependencies: ["@coss/kbd"],
    type: "registry:block",
  },
  {
    categories: categories("label", "input"),
    description: "Label with input",
    files: [{ path: "particles/p-label-1.tsx", type: "registry:block" }],
    name: "p-label-1",
    registryDependencies: ["@coss/input", "@coss/label"],
    type: "registry:block",
  },
  {
    categories: categories("label", "checkbox"),
    description: "Label with checkbox and disabled state",
    files: [{ path: "particles/p-label-2.tsx", type: "registry:block" }],
    name: "p-label-2",
    registryDependencies: ["@coss/checkbox", "@coss/label"],
    type: "registry:block",
  },
  ...
  },
  {
    ...
    files: [{ path: "particles/p-menubar-2.tsx", type: "registry:block" }],
    name: "p-menubar-2",
    registryDependencies: ["@coss/menubar", "@coss/menu"],
    type: "registry:block",
  },
  ...
  },
  {
    ...
    files: [
      { path: "particles/p-navigation-menu-2.tsx", type: "registry:block" },
    ],
  ...
  },
  {
    ...
    files: [{ path: "particles/p-resizable-2.tsx", type: "registry:block" }],
    meta: {
      className: "**:data-[slot=preview]:w-full",
    },
    name: "p-resizable-2",
  ...
  },
  {
    ...
    files: [
      { path: "particles/p-select-native-2.tsx", type: "registry:block" },
    ],
  ...
  },
  {
    ...
    files: [{ path: "particles/p-spinner-2.tsx", type: "registry:block" }],
    name: "p-spinner-2",
    registryDependencies: ["@coss/spinner"],
    type: "registry:block",
  },
  ...
  {
    categories: categories("stepper", "loading"),
    description: "Vertical stepper with descriptions and a loading step",
    files: [{ path: "particles/p-stepper-2.tsx", type: "registry:block" }],
    meta: {
      className: "**:data-[slot=preview]:w-full",
    },
    name: "p-stepper-2",
  ...
  },
  {
    ...
    files: [{ path: "particles/p-timeline-2.tsx", type: "registry:block" }],
    meta: {
      className: "**:data-[slot=preview]:w-full",
    },
    name: "p-timeline-2",
  ...
  },
  {
    ...
    files: [{ path: "particles/p-toolbar-2.tsx", type: "registry:block" }],
    name: "p-toolbar-2",
  ...
  {
    categories: categories("tree", "checkbox"),
    dependencies: ["@headless-tree/react"],
    description: "Checkbox tree with cascading checked state",
    files: [{ path: "particles/p-tree-2.tsx", type: "registry:block" }],
    name: "p-tree-2",
